 ...
 * Date: 10/9/17
 * Time: 3:21 PM
 * Description: This file contains asks the user to enter the barcode for the product to
 *              be updated.
*/
...
// If there is at least one user with the same username or email, display an error message
    ...
    <form method="post" id="" action="updateProductInfo2.php" style="margin-left: 3%;">


        <label style="">Enter Product Barcode: </label>
